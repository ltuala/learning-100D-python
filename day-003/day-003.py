...
red_blue_yellow = input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which coour do you choose?\n")
if (red_blue_yellow.lower() == 'red'):
    print("Burned by fire. Game Over.\n")
    exit(0)
    
if (red_blue_yellow.lower() == 'blue'):
    print("Eaten by beasts. Game Over.\n")
    exit(0)
if (red_blue_yellow.lower() == 'yellow'):
    print("You Win!\n")
    exit(0)
